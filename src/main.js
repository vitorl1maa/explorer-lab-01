...
// não execultar o evento padrao ao clicar no button
...
cardHolder.addEventListener("input", () => {
  ...
  //holder name
  // quando digitar manter o valor digitado, caso esse valor seja 0 manter o valor padrão do texto(FULANO DA SILVA)
